...
import kaizenlogo from "./kaizen2logo.png";
...
const Multiuser_Login_Page = () => {
    ...
    return (
        ...
        <div className="uuu"> 
      <div className ="tt">  <div className="outerkaizen"> <img src={kaizenlogo} className ="kaizenlogo"/> </div> </div>
        <div className="ooo"> 
            ...
            <form className="signinform"> <div className="aa">
                ...
                <button type="Login" className="button"> Submit Detail </button>
        ...
        <img src ={zohocompanylogo} id ="zohologo"/> </a>
        </div> 
        </div>
